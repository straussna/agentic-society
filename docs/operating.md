...
| `py -3 harness.py --print-files corpus` | Print the starter files' manifest and digest; starts no episode. Audits invariant 9 the way `--print-system` audits invariant 2. |
...
`context_fraction`, `max_tokens`, `max_turns`, `timeout`, `live_balance`, `grace_episodes`,
